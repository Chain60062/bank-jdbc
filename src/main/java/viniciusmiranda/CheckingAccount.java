...
public class CheckingAccount extends BankAccount {
    ...
    public CheckingAccount(String firstName, String middleName, String lastName, boolean isSavings) {
        super(firstName, middleName, lastName, isSavings);
    }
    
    public CheckingAccount(Person accountHolder, String accountNumber, double balance, boolean isSavings) {
     ...
     *                          mensal.
     * @return O valor final simulado pelo cálculo de CDB, com desconto de 20% de imposto
     */
